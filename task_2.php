                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            foreach ($myArray as $myArr):?>
                                <h2>
                                    <?=$myArr[title]?>
                                    <span style="padding-left: 30px;font-size:11px;color:ccc">
                                        <?=$myArr[data]?>
                                    </span>
                                </h2>
                                <p><?=$myArr[text]?></p>
